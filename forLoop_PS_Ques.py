...
# # prints entered input num table upto 20 multiple
...
# # prints tables from 1 to entered input num upto 10 multiples
# num=int(input('enter any number '))
...
# # print every table upto 20 multiples
# for i in range(1,11):
#   for j in range(1,21):
#     print(i,'*',j,'=',i*j)
#   print('\n')
